...
FILTER='-vf "normalize=blackpt=black:whitept=white:smoothing=60:strength=1.0,eq=contrast=1.1:saturation=1.8,curves=blue=\'0/0 0.5/0.45 1/1\',unsharp=7:7:1.2,hflip,vflip"'
FILTER_DARK='-vf "normalize=blackpt=black:whitept=white:smoothing=60:strength=1.0,eq=brightness=0.1:contrast=1.2:saturation=1.8,curves=blue=\'0/0 0.5/0.45 1/1\',unsharp=7:7:1.2,hflip,vflip"'
