...
#NUKED python convert.py /gopro /sharphigh 229.mp4
#NUKED python convert.py /gopro /sharphigh pistadh.mp4
#NUKED python convert.py /gopro /sharphigh collesogno.mp4
#NUKED python convert.py /gopro /sharphigh tesoro.mp4
#NUKED python convert.py /gopro /sharphigh 815.mp4
#NUKED python convert.py /gopro /sharphigh 604.mp4
#NUKED python convert.py /ev0 /sharphigh tornantini.mp4
#NUKED python convert.py /sharphigh farwest.mp4
python convert.py /4k /panning forcella_alta_panorama_2.mp4
python convert.py 812.mp4
python convert.py /4k /shaky /panning trefaggi_panorama.mp4
#NUKED python convert.py trefaggi.mp4
#NUKED python convert.py /dark strada_per_blello_selino.mp4
...
#NUKED python convert.py linzone_piacca.mp4
#NUKED python convert.py piacca_baita_palazzago.mp4
python convert.py /4k linzone_panorama.mp4
#NUKED python convert.py valcava_funivia_coldara.mp4
#NUKED python convert.py coldara_pedrino_opreno.mp4
#NUKED python convert.py opreno_burligo.mp4
...
python convert.py /flip tornantini_busto.mp4
python convert.py /flip /dark 604_busto.mp4
python convert.py /flip sanrocco.mp4
python convert.py /flip rocce.mp4
python convert.py /flip scalette.mp4
python convert.py /flip gussa_est_busto.mp4
...
python convert.py /sunny uccellaia_bis.mp4
python convert.py /sunny androli_chignolo.mp4
