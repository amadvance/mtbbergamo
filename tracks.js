...
{ zone: 'hidden', name: 'Bustoseta, Selino', kind: 'down', file: 'I_BustosetaSelino_REC.gpx', link: '2019/07/locatello' },
{ zone: 'hidden', name: 'Buonanome, Selino', kind: 'down', file: 'I_BuonanomeSelino_REC.gpx', link: '2019/07/locatello' },
{ zone: 'hidden', name: 'Coegia, Selino', kind: 'down', file: 'I_CoegiaSelino_REC.gpx', link: '2019/07/locatello' },
{ zone: 'imagna', name: 'Passo Porta, 586, Ca Piatone, Ca Prospero, Selino', kind: 'down', file: 'I_PassoPorta586CaPiatoneCaProsperoSelino_REC.gpx', link: '2019/06/passo-porta' },
{ zone: 'imagna', name: 'Cascine Zucchero, Pramagnone, Ponte Vanzarolo, Ca Piatone, Campi, Selino', kind: 'down', file: 'I_CascineZuccheroPramagnoneVanzaroloCaPiatoneCampiSelino_REC.gpx', link: '2019/07/pramagnone' },
{ zone: 'imagna', name: 'Rota d\'Imagna, Fucine, Selino', kind: 'down', file: 'I_RotaFucineSelino_REC.gpx', link: '2019/06/rota-imagna' },
{ zone: 'hidden', name: 'Rota d\'Imagna, CaProspero, Selino', kind: 'down', file: 'I_RotaCaProsperoSelino_REC.gpx', link: '2019/06/rota-imagna' },
{ zone: 'hidden', name: 'Ca Piatone, Campi, Selino', kind: 'down', file: 'I_CaPiatoneCampiSelino_REC.gpx', link: '2019/06/rota-imagna' },
{ zone: 'hidden', name: 'Ponte Vanzarolo, CaPiatone', kind: 'down', file: 'I_VanzaroloCaPiatone_REC.gpx', link: '2019/07/vanzarolo' },
{ zone: 'imagna', name: 'Ponte Vanzarolo, Chignolo', kind: 'down', file: 'I_VanzaroloChignolo_REC.gpx', link: '2019/07/vanzarolo' },
{ zone: 'imagna', name: 'Ca Piatone, Chignolo', kind: 'down', file: 'I_CaPiatoneChignolo_REC.gpx', link: '2019/07/vanzarolo' },
...
{ zone: 'imagna, ubione', name: 'Roccoli Passata, Costa Cavallina', kind: 'down', file: 'I_CostaCavallina_REC.gpx', link: '2019/09/costa-cavallina' },
{ zone: 'imagna, ubione', name: 'Roccoli Passata, Sopracorna', kind: 'down', file: 'I_Sopracorna_REC.gpx' },
{ zone: 'imagna, ubione', name: 'Corna Marcia, Coyote Scamburtit, Ca Bonor\u00E8', kind: 'down', file: 'I_CoyoteScamburtit_REC.gpx', link: '2019/09/coyote-scamburtit' },
...
{ zone: 'imagna, ubione', name: 'Salita dalla ciclabile del Chito alla Corna Marcia', kind: 'up', file: 'I_SalitaChitoBottaCornaMarcia_EBIKE.gpx', link: '2018/12/salite-imagna' },
{ zone: 'imagna, ubione', name: 'Salita dalla ciclabile del Chito ai Roccoli Passata', kind: 'up', file: 'I_SalitaChitoCeresolaCantoPassata.gpx', link: '2018/12/salite-imagna' },
{ zone: 'imagna, ubione', name: 'Salita da Clanezzo ai Roccoli Passata', kind: 'up', file: 'I_SalitaClanezzoRoccoliPassata_EBIKE.gpx', link: '2018/12/salite-imagna' },
...
{ zone: 'martino, imagna, valcava', name: 'Salita da Valcava al Linzone', kind: 'up', file: 'N_ValcavaLinzone_REC.gpx', link: '2018/12/salite-imagna' },
...
{ zone: 'martino, valcava', name: 'Ciacallo, Burligo', kind: 'down', file: 'N_Ciacallo_REC.gpx', link: '2019/04/colle-pedrino'  },
...
{ zone: 'hidden', name: '807 / Palestra', kind: 'down', file: 'N_807Palestra_REC.gpx', link: '2019/04/colle-pedrino' },
{ zone: 'hidden', name: 'Mulattiera', kind: 'down', file: 'N_PedrinoMulattieraOpreno_REC.gpx', link: '2019/04/colle-pedrino'  },
...
{ zone: 'martino, valcava', name: 'Valcava, Funivia, Coldara, Colle Pedrino, Opreno, Burligo', kind: 'down', file: 'N_ValcavaColdaraPedrinoOprenoBurligo_REC.gpx', link: '2019/01/funivia-coldara-colle-pedrino-opreno' },
...
{ zone: 'martino, valcava', name: 'Valcava, 823, Colle di Sogno, Corna Martinella, Classica', kind: 'down', file: 'N_Valcava823SognoMartinellaClassica_REC.gpx', link: '2018/12/valcava-colle-di-sogno-corna-martinella' },
{ zone: 'martino, valcava', name: 'Valcava, 821, Torre de Busi', kind: 'down', file: 'N_Valcava821Busi_REC.gpx', link: '2019/12/valcava-821-busi' },
...
{ zone: 'martino, valcava', name: 'Forcella Alta, 811, Carenno', kind: 'down', file: 'N_ForcellaAlta811Carenno_REC.gpx', link: '2020/01/forcella-alta-811-carenno' },
{ zone: 'martino, valcava', name: 'Monte Tesoro, Direttissima, Colle Di Sogno, Corna Martinella, Cristai Super Flow', kind: 'down', file: 'N_TesoroDirSognoMartinellaCristaiSuperFlow_REC.gpx', link: '2018/12/monte-tesoro-direttissima-colle-di' },
{ zone: 'martino', name: 'Colle Di Sogno, 819', kind: 'down', file: 'N_ColleDiSogno819_REC.gpx', link: '2019/12/colle-di-sogno' },
{ zone: 'martino', name: 'Colle Di Sogno, 823', kind: 'down', file: 'N_ColleDiSogno823_REC.gpx', link: '2019/12/colle-di-sogno' },
{ zone: 'martino', name: 'Colle Di Sogno, Corna Martinella, Explo', kind: 'down', file: 'N_ColleDiSognoCornaMartinellaExplo_REC.gpx', link: '2019/12/colle-di-sogno' },
{ zone: 'hidden', name: 'Colle Di Sogno, 811, Carenno', kind: 'down', file: 'N_ColleDiSogno811_REC.gpx', link: '2019/12/colle-di-sogno' },
{ zone: 'hidden', name: 'Colle Di Sogno, Corna Martinella, Nord', kind: 'down', file: 'N_ColleDiSognoCornaMartinellaNord_REC.gpx', link: '2019/12/colle-di-sogno' },
{ zone: 'hidden', name: 'Colle Di Sogno, Corna Martinella, Sud', kind: 'down', file: 'N_ColleDiSognoCornaMartinellaSud_REC.gpx', link: '2019/12/colle-di-sogno' },
{ zone: 'martino', name: 'Corna Martinella, 822, 801A', kind: 'down', file: 'N_CornaMartinella822801A_REC.gpx', link: '2020/01/corna-martinella' },
{ zone: 'hidden', name: 'Corna Martinella, Classica', kind: 'down', file: 'N_CornaMartinellaClassica_REC.gpx', link: '2020/01/corna-martinella' },
{ zone: 'hidden', name: 'Corna Martinella, Cristai Super Flow', kind: 'down', file: 'N_CornaMartinellaCristaiSuperFlow_REC.gpx', link: '2020/01/corna-martinella' },
{ zone: 'martino', name: 'Coldara, PizzoPec, Torre de Busi', kind: 'down', file: 'N_ColdaraPizzoPec_REC.gpx', link: '2020/01/coldara' },
{ zone: 'martino', name: 'Coldara, San Marco, Torre de Busi', kind: 'down', file: 'N_ColdaraSanMarco_REC.gpx', link: '2020/01/coldara' },
{ zone: 'martino', name: 'Coldara, Val Bratta, Torre de Busi', kind: 'down', file: 'N_ColdaraValBratta_REC.gpx', link: '2020/01/coldara' },
{ zone: 'hidden', name: 'Coldara, Col Fopa, Opreno', kind: 'down', file: 'N_ColdaraColFopaOpreno_REC.gpx', link: '2020/01/coldara' },
{ zone: 'martino, valcava', name: 'Salita da Torre De Busi a Valcava', kind: 'up', file: 'N_SalitaBusiValcava_EBIKE.gpx', link: '2018/12/salite-san-martino' },
...
{ zone: 'martino, valcava', name: 'Salita da Carenno alla Corna Martinella', kind: 'up', file: 'N_SalitaCarenno819CornaMartinella_EBIKE.gpx', link: '2018/12/salite-san-martino' },
...
{ zone: 'martino, valcava', name: 'Salita dal Passo di Valcava al Monte Tesoro', kind: 'up', file: 'N_SalitaValcavaTesoro_EBIKE.gpx', link: '2018/12/salite-san-martino' },
...
{ zone: 'martino, valcava', name: 'Salita da Torre De Busi alla Corna Martinella', kind: 'up', file: 'N_SalitaBusiCornaMartinella_EBIKE.gpx', link: '2018/12/salite-san-martino' },
...
{ zone: 'canto', name: 'Pietra Sant Alberto', kind: 'down', file: 'C_PietraSAlberto_REC.gpx', link: '2020/03/pietra-santalberto' },
...
{ zone: 'canto', name: 'Uccellaia 1 e 2', kind: 'down', file: 'C_Uccellaia1E2_REC.gpx', link: '2019/02/uccellaia' },
{ zone: 'canto', name: 'Zandona', kind: 'down', file: 'C_Zandona_REC.gpx', link: '2019/02/zandona' },
{ zone: 'canto', name: 'Porcile, San Giovanni', kind: 'down', file: 'C_PorcileSanGiovanni_REC.gpx', link: '2020/03/porcile-san-giovanni' },
{ zone: 'canto', name: 'Salita da Sotto il Monte', kind: 'up', file: 'C_SalitaSottoIlMonte_REC.gpx', link: '2019/02/salite-monte-canto' },
{ zone: 'hidden', name: 'Salita da Sotto il Monte', kind: 'up', file: 'C_SalitaSottoIlMonte_EBIKE.gpx', link: '2019/02/salite-monte-canto' },
{ zone: 'canto', name: 'Salita da Somasca a Pontida', kind: 'up', file: 'C_SalitaSomascaPontida_EBIKE.gpx', link: '2019/02/salite-monte-canto' },
{ zone: 'hidden', name: 'Salita al Crocione', kind: 'up', file: 'C_SalitaCrocione_EBIKE.gpx', link: '2019/02/salite-monte-canto' },
...
{ zone: 'canto', name: 'Salita da Somasca', kind: 'up', file: 'C_SalitaSomasca_EBIKE.gpx', link: '2019/02/salite-monte-canto' },
{ zone: 'hidden', name: 'Salita da Pontida', kind: 'up', file: 'C_SalitaPontida_EBIKE.gpx', link: '2019/02/salite-monte-canto' },
...
{ zone: 'seriana, misma', name: 'Misma, Pradale', kind: 'down', file: 'S_MismaPradale_REC.gpx' },
{ zone: 'seriana, misma', name: 'Salita da Pradaluna, Morosini, Monte Misma', kind: 'up', file: 'S_SalitaMorosiniMisma_EBIKE.gpx', link: '2019/03/salite-valle-seriana' },
...
{ zone: 'gandino', name: 'Gandino, Monte Farno, Rifugio Parafulmine', kind: 'up', file: 'GA_SalitaGandinoRifugioParafulmine_EBIKE.gpx', link: '2020/02/pizzo-formico' },
{ zone: 'gandino', name: 'Rifugio Parafulmine, Pizzo Formico', kind: 'up', file: 'GA_SalitaRifugioParafulminePizzoFormico_EBIKE.gpx', link: '2020/02/pizzo-formico' },
];
